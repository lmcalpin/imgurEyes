...
@implementation ImgurHistoryViewController
...
- (void) createModel {
	NSArray *history = [SqliteDatabase history];
	self.dataSource = [[[UploadHistoryDataSource alloc]
						initWithHistory:history] autorelease];
}
